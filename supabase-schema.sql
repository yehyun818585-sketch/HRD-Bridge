...
INSERT INTO courses (company_id, name, status, stage, issues) VALUES
  ...
  ('22222222-2222-2222-2222-222222222222', '데이터분석 과정', 'draft', '준비중', '증빙서류 미첨부'),
  ('22222222-2222-2222-2222-222222222222', '클라우드 엔지니어 과정', 'rejected', '반려', '개발진 착수 미확인'),
  ('33333333-3333-3333-3333-333333333333', '보안 전문가 과정', 'pending', '승인대기', NULL);
